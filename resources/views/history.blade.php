                ...
                <form id="form-filters" action="{{ route('history', ['page' => 1]) }}" method="GET">
                    ...
                    <div class="mt-5 flex flex-col">
                        ...
                        <a href="{{ route('history', ['page' => $page]) }}" type="button"
                            class="text-center py-2.5 px-5 me-2 mb-2 text-sm font-medium text-gray-900 focus:outline-none bg-white rounded-lg dark:bg-gray-600 dark:border-gray-600 dark:text-white border border-gray-200 hover:bg-gray-100 hover:text-blue-700 focus:z-10 focus:ring-4 focus:ring-gray-100 dark:focus:ring-gray-700">Limpar
                            Filtros</a>
                    </div>
                </form>
            </div>
