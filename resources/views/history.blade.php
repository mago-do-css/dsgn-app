                        ...
                        @foreach ($tiposImagem as $tipo)
                            <li class="w-full border-b border-gray-200 rounded-t-lg dark:border-gray-600">
                                <div class="flex items-center ps-3">
                                    ...
                                    <label for="{{ $tipo['name'] . '-' . $tipo['id'] }}" class="w-full py-3 ms-2 text-sm font-medium text-gray-900 dark:text-gray-300">{{ $tipo['name'] }}</label>
                                </div>
                            </li>
                        @endforeach
                    </ul>
                ...
                <form class="w-full mx-auto mb-4" action="{{ route('history', ['page' => 1]) }}" method="GET">
                    ...
                    <div class="relative">
                        ...
                        <input type="search" 
                            ...
                            placeholder="Procure por Mockups, Logos..." required 
                            name="search" />
                        <button type="submit"
